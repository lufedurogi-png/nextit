                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`block w-full px-4 py-3 pl-11 rounded-lg text-sm border-2 transition-colors focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 ${
                                            darkMode
                                                ? (email.trim() ? 'bg-[#E5EBFD] border-gray-600 text-black' : 'bg-gray-800 border-gray-700 text-black')
                                                : (email.trim() ? 'bg-[#E5EBFD] border-gray-300 text-black' : 'bg-white border-gray-300 text-black')
                                        }`}
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`block w-full px-4 py-3 pl-11 pr-12 rounded-lg text-sm border-2 transition-colors focus:ring-2 focus:ring-emerald-500/40 focus:border-emerald-500 ${
                                            darkMode
                                                ? (password.trim() ? 'bg-[#E5EBFD] border-gray-600 text-black' : 'bg-gray-800 border-gray-700 text-black')
                                                : (password.trim() ? 'bg-[#E5EBFD] border-gray-300 text-black' : 'bg-white border-gray-300 text-black')
                                        }`}
