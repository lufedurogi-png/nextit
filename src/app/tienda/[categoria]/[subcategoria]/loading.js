export default function SubcategoriaLoading() {
    return (
        <div className="min-h-screen min-w-full bg-tienda-canvas">
            <div className="h-14 shrink-0 bg-tienda-elevated border-b border-gray-700" />
            <div className="flex min-h-[calc(100vh-3.5rem)]">
                <aside className="w-64 shrink-0 border-r border-gray-700 bg-tienda-elevated/80 p-6 space-y-8">
                ...
                <main className="flex-1 min-w-0 p-8">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {[...Array(12)].map((_, i) => (
                                <div key={i} className="rounded-lg border border-gray-700 bg-tienda-elevated/60 overflow-hidden">
