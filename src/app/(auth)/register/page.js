    ...
    return (
        <div className="relative w-full flex-1 flex flex-col min-h-0 h-full" style={{ minHeight: 'calc(100vh - 4rem)' }}>
            ...
            <div className="flex flex-col lg:flex-row flex-1 min-h-0 w-full max-w-[1920px] mx-auto relative lg:pl-[14vw] xl:pl-[18vw] 2xl:pl-[22vw]">
                    ...
                    <div className="mx-auto w-full max-w-md shrink-0 self-start lg:mx-auto lg:w-full lg:max-w-[720px]">
                        ...
                        <form onSubmit={submitForm} className="contents">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`block w-full px-4 py-3 pl-12 rounded-lg text-sm transition-all duration-200 ${
                                            darkMode 
                                                ? (name.trim() ? 'bg-[#E5EBFD] border-2 border-gray-600 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20' : 'bg-gray-800 border-2 border-gray-700 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20')
                                                : (name.trim() ? 'bg-[#E5EBFD] border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20' : 'bg-white border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20')
                                        }`}
                                    ...
                                    <Input
                                        ...
                                        className={`block w-full px-4 py-3 pl-12 pr-12 rounded-lg text-sm transition-all duration-200 ${
                                            darkMode 
                                                ...
                                                : (password.trim() ? 'bg-[#E5EBFD] border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20' : 'bg-white border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20')
                                        }`}
                            ...
                            <div>
                                ...
                                <div className={`relative ${showConfirmModal ? 'z-[60]' : ''}`}>
                                    <Input
                                        ...
                                        className={`block w-full px-4 py-3 pl-12 pr-12 rounded-lg text-sm transition-all duration-200 ${
                                            darkMode 
                                                ? (passwordConfirmation.trim() ? 'bg-[#E5EBFD] border-2 border-gray-600 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20' : 'bg-gray-800 border-2 border-gray-700 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20')
                                                : (passwordConfirmation.trim() ? 'bg-[#E5EBFD] border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20' : 'bg-white border-2 border-gray-300 text-black placeholder-gray-500 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/20')
                                        }`}
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-start">
                                    ...
                                    >
                                        <input
                                            ...
                                            type="checkbox"
                                            name="remember"
                                            className={`rounded border-gray-300 text-[#2563eb] shadow-sm focus:border-[#2563eb] focus:ring focus:ring-[#2563eb] focus:ring-opacity-50 ${
                                    ...
                                    <div className="flex min-w-0 flex-1 items-start gap-2">
                                        <input
                                            id="privacy_accept"
                                            type="checkbox"
                                            className={`mt-0.5 shrink-0 rounded border-gray-300 text-[#2563eb] shadow-sm focus:border-[#2563eb] focus:ring focus:ring-[#2563eb] focus:ring-opacity-50 ${
                                                darkMode ? 'border-gray-600 bg-gray-800' : 'bg-white'
                                            }`}
                            ...
                            <Button 
                                ...
                                className="w-full bg-gradient-to-r from-[#0b1b3c] to-[#2563eb] hover:from-[#132e5c] hover:to-[#1d4ed8] text-white px-8 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
                                Registrarse
                            </Button>
                ...
                <div 
                    className={`lg:absolute lg:right-0 lg:top-0 lg:bottom-0 flex items-center justify-center bg-gradient-to-br from-[#0b1b3c] to-[#2563eb] transition-all duration-1000 ease-in-out z-30 order-1 lg:order-2 flex-none min-h-[200px] sm:min-h-[220px] lg:min-h-0 lg:h-full lg:flex-1 ${
                        isExpanded 
                    ...
                    >
                        <div className="mx-auto w-full max-w-md">
                            ...
                            <button
                                type="button"
                                onClick={handleSwitchToLogin}
                                className="rounded-lg border-2 border-white px-5 py-2 text-sm font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-white hover:text-[#0b1b3c] sm:px-8 sm:py-3 sm:text-base"
                            >
                                Iniciar sesión
                            </button>
                            </div>
